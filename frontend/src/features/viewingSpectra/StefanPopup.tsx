...
export function StefanPopup({ spectra }: Props) {
  ...
  if (spectra.length === 0) return null
    ...
    return (
      ...
      {isOpen && createPortal(
        ...
        {/* Spectrum image — 2.5:1 ratio, scrollable in scroll mode */}
        <div
        style={{
          width: '100%',
          aspectRatio: '2.5 / 1', //Stefan edit: from 3:1 to 2.5 to 1
        ...
        style={{
          display: 'block',
          width: viewMode === 'fit' ? '98%' : `${zoom * 100}%`, //stefan edit 100% to 98%
          height: viewMode === 'fit' ? '98%' : 'auto', //stefan edit 100% to 98%
